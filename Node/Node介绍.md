...
* 服务端渲染，服务器处理html，然后直接返回给客户端
* 客户端渲染，服务端只处理数据并返回，客户端动态渲染数据
* 服务端渲染------由于服务器处理整个html，所以网页查看源代码时，数据在HTML代码中
* 客户端渲染------由于服务器只处理返回数据，客户端动态渲染数据，所以网页查看源代码时，数据没有在HTML代码中
* 服务端渲染优势------由于数据是在HTML代码中，搜索引擎 SEO 可以通过数据作为关键词，从而实现 SEO 搜索引擎优化
* 客户端渲染优势------由于相比客户端渲染，服务端渲染页面出现速度较比服务端快（指的是无数据的空页面），用户体验感较好
* 服务端渲染场景------例如：官网的首页
* 客户端渲染场景------例如：官网的子页
